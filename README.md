# Avito.Tech Test Project QA

Тестовое задание от **Avito.Tech** на должность QA-инженера.
...
├── t-1/                               # Первое тестовое задание (документация)
│   └── README.md
├── t-2.2/                             # Второе тестовое задание (автотесты)
